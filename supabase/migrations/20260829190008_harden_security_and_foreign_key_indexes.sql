-- Some linked projects predate Lemma and contain Supabase's auto-RLS helper,
-- while a clean local database does not. Harden it when present without making
-- the migration chain depend on that project-specific object.
do $$
begin
